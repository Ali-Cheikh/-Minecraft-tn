...
To join our server, simply add the server IP **play.minecraft.tn** to your Minecraft client. You can also join our Discord community for updates, support, and to connect with other players.
